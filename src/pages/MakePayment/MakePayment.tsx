...
function ChipIcon({ kind }: { kind: 'calendar' | 'seat' | 'clock' }) {
  if (kind === 'calendar') {
    return (
                  ...
                  return (
                    ...
                    >
                      ...
                      <span className="make-payment__method-body">
                        <span className="make-payment__method-icon-wrap" aria-hidden>
                          {m.icon === 'card' ? (
                            <CreditCardIcon />
                          ) : (
                            <PaypalMarkIcon />
            ...
            <section className="make-payment__card make-payment__card--trust" aria-label="Security">
              <div className="make-payment__trust-row">
                <div className="make-payment__trust-main">
                  <span className="make-payment__trust-shield" aria-hidden>
                    <ShieldCheckIcon />
                  </span>
                ...
                <div className="make-payment__trust-badges">
                  ...
                  <div className="make-payment__trust-partner">
                    <LockSmallIcon />
                    <span>{trust.partnerLabel}</span>
                  </div>
                </div>
              </div>
            </section>
